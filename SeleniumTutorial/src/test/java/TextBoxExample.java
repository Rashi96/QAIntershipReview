...
public class TextBoxExample {
    ...
    public void openTextBoxTestPage() throws InterruptedException {
        ...
        Thread.sleep(3000);// wait ekk dena eka
    }
    ...
    public void textBoxTests(){
        ...
        driver.findElement(By.id("j_idt88:j_idt99")).sendKeys("minolirashmitha228@gmail.com" + Keys.TAB + "Confirmed control moved to next element");
    }
